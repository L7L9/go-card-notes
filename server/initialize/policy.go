...
func initPolicy() error {
	...
	entities := []gormadapter.CasbinRule{
		// 定义超级管理员的权限
		{Ptype: "p", V0: "1", V1: "/user/changePassword/", V2: "PUT"},
		{Ptype: "p", V0: "1", V1: "/user/updateUserInformation/", V2: "PUT"},
		{Ptype: "p", V0: "1", V1: "/user/operateFollow/", V2: "POST"},
		...
		// 定义管理员的权限
		{Ptype: "p", V0: "2", V1: "/user/changePassword/", V2: "PUT"},
		{Ptype: "p", V0: "2", V1: "/user/updateUserInformation/", V2: "PUT"},
		{Ptype: "p", V0: "2", V1: "/user/operateFollow/", V2: "POST"},
		...
		// 定义普通用户的权限
		{Ptype: "p", V0: "3", V1: "/user/changePassword/", V2: "PUT"},
		{Ptype: "p", V0: "3", V1: "/user/updateUserInformation/", V2: "PUT"},
		{Ptype: "p", V0: "3", V1: "/user/operateFollow/", V2: "POST"},
